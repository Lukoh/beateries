...
/**
 * Define event to handle sending the hangout, picked by the user, to BEatery Server.
 *
 * <p>
 ...
 *
 */
public class SelectHangoutEvent extends ResponseEvent {
    public static final int SELECT_HANGOUT_SUCCESS = 1;
    public static final int SELECT_HANGOUT_FAILURE = 0;
    ...
    public void parseInResponse() {
        if (mResponseClient != null && mResponseClient.isSuccessful()) {
            ...
            mResult = SELECT_HANGOUT_SUCCESS;
        } else {
            mResult = SELECT_HANGOUT_FAILURE;
        }
    }
