...
/**
 * Define action to handle getting the updated eatery's information.
 *
 * <p>
 ...
 *
 */
public class EateryInfoUpdatedAction {
    private EateryInfo mEateryInfo;

    public EateryInfoUpdatedAction(EateryInfo eateryInfo) {
