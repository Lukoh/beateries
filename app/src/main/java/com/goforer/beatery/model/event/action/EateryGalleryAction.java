...
/**
 * Define action to handle getting the eatery's gallery contents.
 *
 * <p>
 ...
 *
 */
public class EateryGalleryAction {
    ...
    public void setEateryId(long eeateryId) {
        mEateryId = eeateryId;
    }

    public void setEateryName(String eateryName) {
        mEateryName = eateryName;
    }
}
