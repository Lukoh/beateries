...
/**
 * Define event to handle getting the eatery's event information.
 *
 * <p>
 ...
 *
 */
public class EateryOccasionEvent extends ResponseListEvent {
    public EateryOccasionEvent(boolean isNew) {
        super(isNew);
    }
}
