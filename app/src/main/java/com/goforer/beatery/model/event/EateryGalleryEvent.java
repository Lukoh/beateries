...
/**
 * Define event to handle getting the eatery's gallery contents.
 *
 * <p>
 ...
 *
 */
public class EateryGalleryEvent extends ResponseListEvent {
    public EateryGalleryEvent(boolean isNew) {
        super(isNew);
    }
}
