...
public class SquircleImageView extends ImageView {
    ...
    /**
     * Sets the content of this ImageView to the the specified Image, if Image is null, set to
     * the default bitmap image.
     *
     * @param image
     * @param defaultImage
     */
    ...
    public void setImage(Image image) {
        ...
        if (image != null) {
            Glide.with(getContext()).load(image.getImageUrl()).asBitmap().into(new SimpleTarget<Bitmap>() {
                @Override
     ...
     * @param image the desired Image
     */
    public void setImageNewCache(Image image) {
        if (image != null) {
            Glide.with(getContext()).load(image.getImageUrl()).asBitmap().signature(
     ...
     */
    public void setImage(Image image, int resizeWidth, int resizeHeight, Drawable defaultImage) {
        setDefaultImage(defaultImage);
        setImage(image, resizeWidth, resizeHeight);
    }
     ...
     * @param resizeHeight the height to resize
     */
    public void setImage(Image image, int resizeWidth, int resizeHeight) {
        if (image != null) {
            Glide.with(getContext()).load(image.getImageUrl()).asBitmap().override(resizeWidth, resizeHeight).into(new SimpleTarget<Bitmap>() {
                @Override
                public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                    if (resource != null) {
                        float scale = 1f;
     ...
     */
    public void setImage(final Image image, @DrawableRes int resId) {
