...
public class SlidingTabLayout extends HorizontalScrollView implements View.OnTouchListener {
    ...
    private boolean mVerticalDivider = true;

    private int mTitleColor;
    private int mSelTitleColor = Color.WHITE;
    ...
    /**
     * Sets the custom {@link TabColorizer} to be used.
     *
    ...
    public void setTitleColor(int titleColor, int selTitleColor) {
        mTitleColor = titleColor;
        mSelTitleColor = selTitleColor;

        if (mTabStrip != null && mViewPager != null) {
            for (int i = 0 ; i < mViewPager.getAdapter().getCount() ; i++) {
                ((TextView)mTabStrip.getChildAt(i).findViewById(mTabViewTextViewId)).setTextColor(mTitleColor);
            }
            ((TextView)mTabStrip.getChildAt(mViewPager.getCurrentItem()).findViewById(mTabViewTextViewId)).setTextColor(mSelTitleColor);

            if (lastButton != null) ((TextView)lastButton.findViewById(mTabViewTextViewId)).setTextColor(mTitleColor);
        }
    }
    ...
    /**
     * Sets the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link SlidingTabLayout} you are
    ...
    public void setCustomTabView(int layoutResId, int textViewId) {
        setCustomTabView(layoutResId, textViewId, 0);
    }
     ...
     * @param layoutResId Layout id to be inflated
     * @param textViewId id of the {@link android.widget.TextView} in the inflated view
     * @param iconViewId id of the {@link android.widget.ImageView} in the inflated view
     */
    public void setCustomTabView(int layoutResId, int textViewId, int iconViewId) {
        setCustomTabView(layoutResId, textViewId, iconViewId, true);
    }
     ...
     * @param textViewId id of the {@link android.widget.TextView} in the inflated view
     * @param iconViewId id of the {@link android.widget.ImageView} in the inflated view
     * @param isVerticalDivider true if you need the vertical divider
     */
    public void setCustomTabView(int layoutResId, int textViewId, int iconViewId,
        ...
        mVerticalDivider = isVerticalDivider;

        mTabStrip.setVerticalDivider(mVerticalDivider);
    }
    ...
    public void setLastButton(String title, OnClickListener clickListener){
        View tabView = null;
        ...
        if (mTitleColor > 0) tabTitleView.setTextColor(mTitleColor);

        lastButton = tabView;
        lastButton.setOnClickListener(clickListener);
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabTitleView.setOnTouchListener(this);
            ...
            if (title == null && tabIconView != null) {
                tabTitleView.setVisibility(View.GONE);
                tabIconView.setVisibility(View.VISIBLE);
                if (adapter instanceof TabIconizer){
                    int icon = ((TabIconizer)adapter).getIconResId(i);
                    if (icon > 0){
            ...
            mTitleColor = tabTitleView.getCurrentTextColor();
        ...
        if(lastButton != null){
            mTabStrip.addView(lastButton);
            lastButton.setOnTouchListener(this);
        }
    }

    public void setTextTabIcon(int index, String title) {
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                TextView tvTitle = (TextView)child.findViewById(mTabViewTextViewId);
                if (tvTitle != null) {
                    tvTitle.setTextColor(mTitleColor);
                    if (position == i) {
                        tvTitle.setTextColor(mSelTitleColor);
                    }
                }
            }
